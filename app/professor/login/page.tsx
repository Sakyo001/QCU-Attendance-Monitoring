  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-emerald-50/50 p-4">
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-xl border border-emerald-200/50 overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 px-6 py-8 text-center">
            ...
            <p className="text-emerald-100">Faculty and adviser access</p>
          </div>
          ...
          <div className="bg-gray-50 px-6 py-4 border-t border-gray-200 text-center text-sm text-gray-600">
            <p>Test credentials: <code className="bg-gray-200 px-2 py-1 rounded">professor@university.edu</code></p>
          </div>
        </div>
      </div>
    </div>
